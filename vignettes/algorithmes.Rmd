...
Le tableau de départ est la matrice termes-documents croisant les segments de texte (unités de contexte élémentaires, *uce*), éventuellement regroupés en unités de contexte (*uc*) s'ils ne comportent pas suffisamment de formes différentes (selon la valeur de l'argument `min_segment_size`), et les termes. Cette matrice est une matrice binaire de présence/absence du terme dans le document, et non une matrice d'effectifs. 
