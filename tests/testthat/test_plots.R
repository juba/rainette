...
res1 <- rainette(dtm, k = 5, min_segment_size = 5, min_split_members = 3)
res2 <- rainette(dtm, k = 5, min_segment_size = 10, min_split_members = 3)
res12 <- rainette2(res1, res2, max_k = 5)

plot1 <- rainette_plot(res1, dtm)
plot2 <- rainette_plot(res1, dtm, free_scales = TRUE)
plot3 <- rainette_plot(res1, dtm, measure = "lr")
plot3b <- rainette_plot(res1, dtm, measure = "frequency")
plot3c <- rainette_plot(res1, dtm, measure = "docprop")
