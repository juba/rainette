...
- Compléter vignette et ajouter tests pour `rainette2_complete_groups`
- Accélérer découpage en segments
- Donner un exemple de calcul des spécificités des mots outils sur des groupes calculés. L'idée est de déterminer si certains mots exclus sont associés à des groupes et donc à les réintégrer comme actifs.
